...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      settingsSubtitle: "Configure how DeskBuddy behaves on your desktop.",
      ...
      sidebarMdownManager: "MDown Manager",
      sidebarTelegramApproval: "Remote Approval",
      statsTitle: "Stats",
      statsSubtitle: "A live overview of DeskBuddy session activity, grouped from the current session snapshot.",
      statsLoadingTitle: "Loading stats",
      statsLoadingBody: "DeskBuddy is collecting the latest session snapshot.",
      statsLoadFailed: "Could not load stats",
      statsEmptyTitle: "No session activity yet",
      statsEmptyBody: "Start Claude Code, Codex, or another connected agent and the activity overview will appear here.",
      statsCardSessions: "Sessions observed",
      statsCardActive: "Active now",
      statsCardNeedsAck: "Awaiting acknowledgement",
      statsCardCoverage: "Coverage",
      statsAgentsTitle: "Agent activity",
      statsAgentsEmpty: "No agent activity yet.",
      statsProjectsTitle: "Project activity",
      statsProjectsEmpty: "No project paths reported yet.",
      statsStatusTitle: "Status mix",
      statsStatusEmpty: "No session states yet.",
      statsHealthTitle: "Health",
      statsHealthLastActivity: "Last activity",
      statsHealthContext: "Context pressure",
      statsHealthRemote: "Remote coverage",
      statsLocalLabel: "local",
      statsRemoteLabel: "remote",
      statsDoneLabel: "done",
      statsInterruptedLabel: "interrupted",
      statsReposLabel: "repos",
      statsHostsLabel: "hosts",
      statsTrackedLabel: "tracked",
      statsNearLimitLabel: "near limit",
      statsPeakLabel: "peak",
      statsSessionsLabel: "sessions",
      statsActiveShort: "active",
      statsUnknownRepo: "Unknown repo",
      statsUnknownLabel: "Unknown",
      statsNever: "No recent activity",
      pluginsTitle: "Plugins",
      pluginsSubtitle: "Bundled DeskBuddy actions inspired by the OpenPets plugin menu. Enabled plugins appear directly in the pet right-click menu.",
      pluginsLoadingTitle: "Loading plugins",
      pluginsLoadingBody: "DeskBuddy is collecting the current plugin state.",
      pluginsLoadFailed: "Could not load plugins",
      pluginsEmptyTitle: "No plugins available",
      pluginsEmptyBody: "Bundled plugins will appear here when DeskBuddy finishes loading.",
      pluginsFilterAll: "All",
      pluginsFilterEnabled: "Enabled",
      pluginsFilterDisabled: "Disabled",
      pluginsFilterMenu: "Menu",
      pluginsStatusActive: "Active",
      pluginsStatusDisabled: "Disabled",
      pluginsStatusBundled: "Bundled",
      pluginsStatusMenu: "Pet menu",
      pluginsCommandsLabel: "Commands",
      pluginsActionConfigure: "Configure",
      pluginsActionHide: "Hide",
      pluginsFooterCount: "{count} bundled plugins",
      pluginBreakBuddyName: "Break Buddy",
      pluginBreakBuddyDesc: "Schedules gentle break nudges so the pet can remind you to step away for a minute.",
      pluginBreakBuddyMenuFive: "Remind me in 5 minutes",
      pluginBreakBuddyMenuTen: "Remind me in 10 minutes",
      pluginBreakBuddyMenuCancel: "Cancel break reminder",
      pluginBreakBuddyQueuedTitle: "Break Buddy",
      pluginBreakBuddyQueuedFive: "Break reminder set for 5 minutes.",
      pluginBreakBuddyQueuedTen: "Break reminder set for 10 minutes.",
      pluginBreakBuddyReadyTitle: "Time for a break",
      pluginBreakBuddyReadyBody: "Stand up, stretch, and give your eyes a short reset.",
      pluginBreakBuddyCanceledBody: "Break reminder cancelled.",
      pluginFocusBuddyName: "Focus Buddy",
      pluginFocusBuddyDesc: "Starts simple focus timers so the pet can nudge you when it is time to wrap a session.",
      pluginFocusBuddyMenuTwentyFive: "Start 25-minute focus",
      pluginFocusBuddyMenuFifty: "Start 50-minute focus",
      pluginFocusBuddyMenuCancel: "Cancel focus timer",
      pluginFocusBuddyQueuedTitle: "Focus Buddy",
      pluginFocusBuddyQueuedTwentyFive: "25-minute focus timer started.",
      pluginFocusBuddyQueuedFifty: "50-minute focus timer started.",
      pluginFocusBuddyReadyTitle: "Focus session complete",
      pluginFocusBuddyReadyBody: "Your focus block is done. Review, commit, and take a breath.",
      pluginFocusBuddyCanceledBody: "Focus timer cancelled.",
      pluginPetPalName: "Pet Pal",
      pluginPetPalDesc: "Quick DeskBuddy shortcuts that open the activity surfaces you are most likely to check mid-session.",
      pluginPetPalMenuDashboard: "Open Sessions Dashboard",
      pluginPetPalMenuStats: "Open Stats",
      pluginPetPalMenuAgents: "Open Agents",
      pluginQuickRemindersName: "Quick Reminders",
      pluginQuickRemindersDesc: "Schedules lightweight follow-up reminders when you want a second nudge without leaving the pet menu.",
      pluginQuickRemindersMenuTen: "Remind me in 10 minutes",
      pluginQuickRemindersMenuThirty: "Remind me in 30 minutes",
      pluginQuickRemindersMenuHour: "Remind me in 1 hour",
      pluginQuickRemindersMenuCancel: "Cancel reminder",
      pluginQuickRemindersQueuedTitle: "Quick Reminders",
      pluginQuickRemindersQueuedTen: "Reminder set for 10 minutes.",
      pluginQuickRemindersQueuedThirty: "Reminder set for 30 minutes.",
      pluginQuickRemindersQueuedHour: "Reminder set for 1 hour.",
      pluginQuickRemindersReadyTitle: "Reminder",
      pluginQuickRemindersReadyBody: "DeskBuddy check-in: revisit the task you parked earlier.",
      pluginQuickRemindersCanceledBody: "Reminder cancelled.",
      pluginWanderBuddyName: "Wander Buddy",
      pluginWanderBuddyDesc: "Lets the pet roam more freely by toggling DeskBuddy movement options directly from the menu.",
      pluginWanderBuddyMenuFreeRoam: "Free roam",
      pluginWanderBuddyMenuEdgePinning: "Allow edge pinning",
      ...
      telegramApprovalBotTokenHintHtml: "Create a bot with [@BotFather](https://t.me/botfather) using /newbot, then paste the token here. It is stored in the user-data env file, never in deskbuddy-prefs.json.",
      ...
      telegramApprovalRecipientHintHtml: "Open [@userinfobot](https://t.me/userinfobot) in Telegram and send /start to get your numeric id. DeskBuddy uses it both as the allowed approver and as the chat to send approval cards. Send /start to your own bot at least once first.",
      ...
      telegramApprovalDirectSendDesc: "When you reply to a DeskBuddy completion notification, focus the matching local terminal and paste one line. It does not send Enter.",
      ...
      remoteSshSubtitle: "Manage one-click SSH tunnels for remote AI coding sessions. Profiles never store passwords or passphrases — DeskBuddy relies on your existing ssh-agent / SSH keys.",
      ...
      remoteSshFieldConnectOnLaunch: "Connect automatically when DeskBuddy starts",
      ...
      remoteSshErrNoLocalPort: "Local DeskBuddy server is not yet running.",
      remoteSshErrUnknownStrikes: "Multiple unrecognized errors in a row — please check the profile and logs.",
      remoteSshProbeLocalUnhealthy: "Tunnel established but local DeskBuddy server is not healthy.",
      remoteSshProbeUnresponsive: "Tunnel established but DeskBuddy is not responding. Make sure DeskBuddy is running.",
      ...
      remoteSshConnectWarnNoDeploy: "Hooks are not deployed yet. Connect alone only builds the SSH tunnel — DeskBuddy will not react to remote sessions until you click Deploy / Repair Hooks.",
      ...
      doctorPrivacy: "Privacy notice: this report is generated locally. DeskBuddy does not upload data. User paths and secrets are redacted before copying.",
      ...
      doctorFixConfirmCodex: "DeskBuddy will set [features].hooks = true in your Codex config. Continue?",
      doctorFixConfirmCodexTitle: "Enable Codex hooks?",
      doctorFixConfirmCodexDetail: "This repair will change your Codex config and set [features].hooks = true. DeskBuddy will not make that change unless you confirm it here.",
      doctorFixConfirmCodexAction: "Enable and repair",
      doctorFixConfirmCancel: "Cancel",
      doctorRestartButton: "Restart DeskBuddy",
      doctorRestarting: "Restarting",
      doctorRestartConfirmTitle: "Restart DeskBuddy?",
      doctorRestartConfirmDetail: "DeskBuddy will close and reopen. In-flight requests from your AI coding agents will be dropped. The Doctor window will close as part of the restart.",
      ...
      doctorConnectionNoActivityHint: "No agent hook traffic reached DeskBuddy during the test. If you haven't enabled an agent yet, enable or install one in Settings, then send a message from that agent and run the test again.",
      ...
      hardwareBuddyQuickCommandsDesc: "Expose local preset buttons that create adapter-owned quick_command events. DeskBuddy does not paste text or run shell commands.",
      ...
      hardwareBuddyTestErr_internal_error: "Hardware Buddy test failed inside DeskBuddy.",
      ...
      agentIntegrationUninstallConfirm: "Uninstall this DeskBuddy-managed integration? Only DeskBuddy-managed hooks, plugins, or extensions will be removed.",
      ...
      agentInstallHintDesc: "Detected local signals for {agents}. Connect them to DeskBuddy by installing DeskBuddy-managed hooks, plugins, or extensions.",
      ...
      agentCleanupHintDesc: "DeskBuddy is connected to {agents}, but no matching local installation was detected. Remove the DeskBuddy-managed integration to stop startup sync and event entry for those agents.",
      agentCleanupHintRemove: "Remove integrations",
      agentCleanupHintDismiss: "Keep for now",
      rowAgentPermissions: "Show pop-up bubbles",
      rowAgentPermissionsDesc: "Turn off to let this agent handle prompts in its own terminal instead of showing a DeskBuddy bubble.",
      ...
      rowCodexPermissionModeDesc: "Native keeps Codex AutoReview and terminal prompts in charge. Intercept shows DeskBuddy Allow/Deny bubbles.",
      ...
      codexHookHealthReasonNeedsReview: "DeskBuddy's Codex hooks are registered but need approval in Codex — run /hooks in Codex, or use Doctor → Fix.",
      codexHookHealthReasonInactive: "DeskBuddy's Codex hook isn't active, so approval prompts won't appear. Reinstall the integration or run Doctor → Fix.",
      ...
      rowSoundDesc: "Play a chime when DeskBuddy finishes a task or asks for input.",
      rowVolume: "Volume",
      rowVolumeDesc: "Adjust sound effect volume. Disabled when sound effects are off.",
      rowLowPowerIdleMode: "Low power idle",
      rowLowPowerIdleModeDesc: "Pause idle SVG animation after DeskBuddy has been still for a few seconds; activity resumes animation immediately.",
      ...
      rowSessionCleanupGroupDesc: "How long DeskBuddy waits before clearing inactive sessions. Mainly affects remote SSH sessions where the terminal isn't visible — raise the limit for long-running remote work, or set Session timeout to 0 to never clear by time.",
      ...
      rowOpenAtLoginDesc: "Start DeskBuddy automatically when you log in.",
      ...
      claudeHooksDisconnectConfirmDetail: "This removes DeskBuddy-managed Claude hooks from ~/.claude/settings.json and turns off automatic management. Start with Claude Code will be kept for later re-enable.",
      ...
      rowStartWithClaudeDesc: "Auto-launch DeskBuddy whenever a Claude Code session starts.",
      ...
      rowHideBubblesDesc: "Hide permission, notification, and update bubbles across DeskBuddy.",
      rowBubbleFollow: "Bubbles follow DeskBuddy",
      ...
      autoApproveAllConfirmDetail: "Every permission request from every agent will be approved automatically, including running shell commands and deleting files. DeskBuddy will not ask you first. Only enable this if you fully trust what your agents are doing.",
      ...
      updateBubbleDisableConfirmDetail: "You may miss update failures, download-complete messages, and restart prompts. The update flow itself will still run, but DeskBuddy will not show update bubbles.",
      ...
      rowDisableMiniModeDesc: "Prevent DeskBuddy from entering mini mode from edge snap or the menu",
      rowFreeRoam: "Free roam",
      rowFreeRoamDesc: "Let DeskBuddy wander freely around the desk when idle. Movement stops when you move the mouse.",
      ...
      placeholderDesc: "This panel will land in a future DeskBuddy release. The plan lives in docs/plans/plan-settings-panel.md.",
      ...
      langJapanese: "日本語",
      themeTitle: "Theme",
      themeSubtitle: "Pick a theme for DeskBuddy. Cards show built-in + capability badges so you can see tracked/static/mini differences before switching.",
      ...
      themeImportUserThemeZip: "Import DeskBuddy theme package (.zip)",
      themeImportUserThemeZipHint: "DeskBuddy theme zip: root or one top-level folder must contain theme.json. Put SVG, GIF, APNG, PNG, WebP, JPG, or JPEG assets in assets/. Use Codex Pet import for Codex Pet packages.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pets refreshed: ${imported} new, ${updated} updated, ${unchanged} unchanged, ${removed} removed${invalid ? `, ${invalid} invalid` : ""}${switched ? "; active theme reset to DeskBuddy" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `Uninstalled "${name}"${switched ? " and switched back to DeskBuddy" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `Couldn't uninstall imported pet: ${message}`,
      animMapTitle: "Animation Map",
      animMapSubtitle: "Silence individual interrupt animations. Events still fire — DeskBuddy just skips the visual and sound for the selected states.",
      ...
      aboutTitle: "About DeskBuddy",
      aboutSubtitle: "Your desktop companion for AI coding sessions.",
      ...
      aboutSourceReposLabel: "Source repos",
      aboutLicenseLabel: "License",
      aboutAuthorLabel: "Made by",
      aboutMaintainersLabel: "Maintainers",
      aboutContributorsLabel: "Contributors",
      aboutFooter: "DeskBuddy is open source. Built with care by the community.",
      aboutCleanupButton: "Remove DeskBuddy integrations…",
      aboutCleanupConfirm: "Remove DeskBuddy-managed hooks/plugins from local agents and mark all agent integrations as uninstalled and disabled in DeskBuddy? This does not delete agent apps or user configs.",
      ...
      aboutCleanupKiroNote: "Kiro deskbuddy.json is kept; only hook entries were removed.",
      mobileTitle: "DeskBuddy Mobile",
      mobileDeviceName: "Device name",
      mobileDesc: "Add this machine to the DeskBuddy Mobile app on your phone to monitor sessions from anywhere. Read-only LAN preview — no write or approval operations.",
      ...
      mobileQrHint: "Scan with your phone's camera to open DeskBuddy Mobile",
      mobileQrHintNative: "Scan with the DeskBuddy Mobile app's built-in scanner",
      mobileClientPwa: "PWA (browser)",
      mobileClientNative: "Native App",
      mobileClientNativeNote: "Requires the DeskBuddy Mobile app to already be installed — this link won't fall back to a browser.",
      ...
      mdownManagerTitle: "MDown Manager",
      mdownManagerSubtitle: "Connect the MDown Manager pet to a running MDown Manager instance so it reflects real scan/summarize/index activity instead of just sitting idle.",
      mdownManagerStatusChecking: "Checking…",
      mdownManagerStatusNotConfigured: "Not configured — paste your API key below.",
      mdownManagerStatusConnected: "Connected.",
      mdownManagerStatusUnauthorized: "Unauthorized — check the API key.",
      mdownManagerStatusOffline: "Offline — is MDown Manager running?",
      mdownManagerConnectionSectionTitle: "Connection",
      mdownManagerBaseUrlLabel: "Local API URL",
      mdownManagerBaseUrlEmpty: "Enter the MDown Manager API URL first.",
      mdownManagerApiKeyLabel: "API key",
      mdownManagerApiKeyHint: "Copy this from MDown Manager's Settings → Local Agent API panel.",
      mdownManagerApiKeyPlaceholder: "Paste API key",
      mdownManagerApiKeyConfiguredPlaceholder: "Key saved — leave blank to keep it",
      mdownManagerSave: "Save",
      mdownManagerSaving: "Saving…",
      mdownManagerConfigSaved: "MDown Manager settings saved.",
      mdownManagerEnableSectionTitle: "Enable",
      mdownManagerEnableLabel: "Reflect MDown Manager activity",
      mdownManagerEnableDesc: "When enabled, the MDM pet switches between idle/scanning/summarizing/indexing/error based on what MDown Manager is actually doing.",
      aboutOpenExternalFailed: "Couldn't open the link in your browser.",
    },
    zh: {
      settingsTitle: "设置",
      settingsSubtitle: "配置 DeskBuddy 在桌面上的行为。",
      ...
      statsTitle: "统计",
      statsSubtitle: "根据当前会话快照汇总的 DeskBuddy 会话活动实时概览。",
      statsLoadingTitle: "正在加载统计",
      statsLoadingBody: "DeskBuddy 正在收集最新的会话快照。",
      statsLoadFailed: "无法加载统计",
      statsEmptyTitle: "暂无会话活动",
      statsEmptyBody: "启动 Claude Code、Codex 或其他已连接的 agent，活动概览会显示在这里。",
      statsCardSessions: "观察到的会话",
      statsCardActive: "当前活跃",
      statsCardNeedsAck: "等待确认",
      statsCardCoverage: "覆盖率",
      statsAgentsTitle: "Agent 活动",
      statsAgentsEmpty: "暂无 Agent 活动。",
      statsProjectsTitle: "项目活动",
      statsProjectsEmpty: "暂未上报任何项目路径。",
      statsStatusTitle: "状态分布",
      statsStatusEmpty: "暂无会话状态。",
      statsHealthTitle: "健康状况",
      statsHealthLastActivity: "最近活动",
      statsHealthContext: "上下文压力",
      statsHealthRemote: "远程覆盖率",
      statsLocalLabel: "本地",
      statsRemoteLabel: "远程",
      statsDoneLabel: "已完成",
      statsInterruptedLabel: "已中断",
      statsReposLabel: "仓库数",
      statsHostsLabel: "主机数",
      statsTrackedLabel: "已跟踪",
      statsNearLimitLabel: "接近上限",
      statsPeakLabel: "峰值",
      statsSessionsLabel: "会话数",
      statsActiveShort: "活跃",
      statsUnknownRepo: "未知仓库",
      statsUnknownLabel: "未知",
      statsNever: "暂无最近活动",
      pluginsTitle: "插件",
      pluginsSubtitle: "受 OpenPets 插件菜单启发的 DeskBuddy 内置操作。启用的插件会直接出现在宠物右键菜单中。",
      pluginsLoadingTitle: "正在加载插件",
      pluginsLoadingBody: "DeskBuddy 正在收集当前插件状态。",
      pluginsLoadFailed: "无法加载插件",
      pluginsEmptyTitle: "暂无可用插件",
      pluginsEmptyBody: "DeskBuddy 加载完成后，内置插件会显示在这里。",
      pluginsFilterAll: "全部",
      pluginsFilterEnabled: "已启用",
      pluginsFilterDisabled: "已禁用",
      pluginsFilterMenu: "菜单",
      pluginsStatusActive: "已启用",
      pluginsStatusDisabled: "已禁用",
      pluginsStatusBundled: "内置",
      pluginsStatusMenu: "宠物菜单",
      pluginsCommandsLabel: "命令",
      pluginsActionConfigure: "配置",
      pluginsActionHide: "隐藏",
      pluginsFooterCount: "共 {count} 个内置插件",
      pluginBreakBuddyName: "休息小助手",
      pluginBreakBuddyDesc: "安排温和的休息提醒，让宠物提醒你抽空离开一会儿。",
      pluginBreakBuddyMenuFive: "5 分钟后提醒我",
      pluginBreakBuddyMenuTen: "10 分钟后提醒我",
      pluginBreakBuddyMenuCancel: "取消休息提醒",
      pluginBreakBuddyQueuedTitle: "休息小助手",
      pluginBreakBuddyQueuedFive: "已设置 5 分钟后提醒休息。",
      pluginBreakBuddyQueuedTen: "已设置 10 分钟后提醒休息。",
      pluginBreakBuddyReadyTitle: "该休息一下了",
      pluginBreakBuddyReadyBody: "起来走走，伸展一下，让眼睛放松片刻。",
      pluginBreakBuddyCanceledBody: "休息提醒已取消。",
      pluginFocusBuddyName: "专注小助手",
      pluginFocusBuddyDesc: "开启简单的专注计时，让宠物在会话该收尾时提醒你。",
      pluginFocusBuddyMenuTwentyFive: "开始 25 分钟专注",
      pluginFocusBuddyMenuFifty: "开始 50 分钟专注",
      pluginFocusBuddyMenuCancel: "取消专注计时",
      pluginFocusBuddyQueuedTitle: "专注小助手",
      pluginFocusBuddyQueuedTwentyFive: "25 分钟专注计时已开始。",
      pluginFocusBuddyQueuedFifty: "50 分钟专注计时已开始。",
      pluginFocusBuddyReadyTitle: "专注时段完成",
      pluginFocusBuddyReadyBody: "专注时段已结束。回顾一下，提交代码，喘口气。",
      pluginFocusBuddyCanceledBody: "专注计时已取消。",
      pluginPetPalName: "宠物伙伴",
      pluginPetPalDesc: "快捷打开你在会话中最常查看的活动面板。",
      pluginPetPalMenuDashboard: "打开会话面板",
      pluginPetPalMenuStats: "打开统计",
      pluginPetPalMenuAgents: "打开 Agent 设置",
      pluginQuickRemindersName: "快速提醒",
      pluginQuickRemindersDesc: "在不离开宠物菜单的情况下，安排一个轻量的后续提醒。",
      pluginQuickRemindersMenuTen: "10 分钟后提醒我",
      pluginQuickRemindersMenuThirty: "30 分钟后提醒我",
      pluginQuickRemindersMenuHour: "1 小时后提醒我",
      pluginQuickRemindersMenuCancel: "取消提醒",
      pluginQuickRemindersQueuedTitle: "快速提醒",
      pluginQuickRemindersQueuedTen: "已设置 10 分钟后提醒。",
      pluginQuickRemindersQueuedThirty: "已设置 30 分钟后提醒。",
      pluginQuickRemindersQueuedHour: "已设置 1 小时后提醒。",
      pluginQuickRemindersReadyTitle: "提醒",
      pluginQuickRemindersReadyBody: "DeskBuddy 提醒你：回顾一下之前搁置的任务。",
      pluginQuickRemindersCanceledBody: "提醒已取消。",
      pluginWanderBuddyName: "漫游小助手",
      pluginWanderBuddyDesc: "通过菜单直接切换 DeskBuddy 的移动选项，让宠物更自由地漫游。",
      pluginWanderBuddyMenuFreeRoam: "自由漫游",
      pluginWanderBuddyMenuEdgePinning: "允许贴边固定",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "去 [@BotFather](https://t.me/botfather) 用 /newbot 创建机器人，把 token 贴到这里。Token 存到 userData env 文件，不会写入 deskbuddy-prefs.json。",
      ...
      telegramApprovalRecipientHintHtml: "去 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私聊 /start 拿到你的数字 ID。DeskBuddy 会用它既作为唯一可审批者，也作为接收审批卡的 chat。记得先去你自己的机器人发一条 /start 激活私聊。",
      ...
      telegramApprovalDirectSendDesc: "回复 DeskBuddy 完成通知时，聚焦对应的本地终端并粘贴单行文本。不会按 Enter。",
      ...
      remoteSshSubtitle: "管理一键 SSH 隧道，让远程 AI 编码会话像本地一样工作。DeskBuddy 不存任何密码或私钥口令——依赖你已配置的 ssh-agent / SSH 密钥。",
      ...
      remoteSshFieldConnectOnLaunch: "DeskBuddy 启动时自动连接",
      ...
      remoteSshErrNoLocalPort: "本地 DeskBuddy 服务尚未启动。",
      remoteSshErrUnknownStrikes: "连续多次未识别错误，请检查配置和日志。",
      remoteSshProbeLocalUnhealthy: "隧道已建立但本地 DeskBuddy 服务异常。",
      remoteSshProbeUnresponsive: "隧道已建立但 DeskBuddy 无响应，请确认 DeskBuddy 在运行。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 文件还没部署。Connect 只建 SSH 隧道，不部署 hook——必须点 Deploy / Repair Hooks 之后 DeskBuddy 才会响应远端会话。",
      ...
      doctorPrivacy: "隐私说明：诊断报告只在本机生成，DeskBuddy 不会上传数据。复制前会脱敏用户路径和密钥。",
      ...
      doctorFixConfirmCodex: "DeskBuddy 会把 Codex 配置里的 [features].hooks 设为 true。继续吗？",
      doctorFixConfirmCodexTitle: "启用 Codex hooks？",
      doctorFixConfirmCodexDetail: "这次修复会修改你的 Codex 配置，把 [features].hooks 设为 true。只有你在这里确认后，DeskBuddy 才会做这个改动。",
      doctorFixConfirmCodexAction: "启用并修复",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重启 DeskBuddy",
      doctorRestarting: "重启中",
      doctorRestartConfirmTitle: "重启 DeskBuddy？",
      doctorRestartConfirmDetail: "DeskBuddy 会关闭并重新启动。AI coding agent 正在进行的请求会被中断。重启过程中 Doctor 窗口也会一起关闭。",
      ...
      doctorConnectionNoActivityHint: "测试期间没有 agent 的 hook 流量到达 DeskBuddy。如果你还没启用 agent，请先在设置里启用或安装一个，然后从该 agent 发一条消息，再重新测试。",
      ...
      hardwareBuddyQuickCommandsDesc: "显示本地 preset 按钮，只创建由 adapter 处理的 quick_command 事件；DeskBuddy 不粘贴文本，也不运行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      hardwareBuddyTestErr_internal_error: "DeskBuddy 内部执行 Hardware Buddy 测试失败。",
      ...
      agentIntegrationUninstallConfirm: "要卸载这个由 DeskBuddy 管理的集成吗？只会移除 DeskBuddy 管理的 hooks、插件或扩展。",
      agentIntegrationInstallSkipped: "没有检测到本机安装了 {agents}，所以没有写入集成。",
      agentListSeparator: "、",
      agentInstallHintTitle: "连接检测到的 Agent",
      agentInstallHintDesc: "检测到本机可能有 {agents}。安装由 DeskBuddy 管理的 hooks、插件或扩展后，它们就能驱动桌宠。",
      agentInstallHintInstallRecommended: "安装推荐项",
      agentInstallHintDismiss: "暂不处理",
      agentCleanupHintTitle: "检查缺失的本机 Agent",
      agentCleanupHintDesc: "DeskBuddy 当前连接了 {agents}，但本机没有检测到对应安装。移除 DeskBuddy 管理的集成后，会同时关闭这些 agent 的启动同步和事件入口。",
      agentCleanupHintRemove: "移除集成",
      agentCleanupHintDismiss: "先保留",
      rowAgentPermissions: "显示弹窗",
      rowAgentPermissionsDesc: "关闭后让该 agent 在自己的终端里处理提示，不再弹 DeskBuddy 气泡。",
      rowAgentSubagentPermissions: "子 agent 权限弹窗",
      rowAgentSubagentPermissionsDesc: "关闭后，Task 子 agent 发起的权限请求不再弹 DeskBuddy 气泡，改回终端处理。",
      rowCodexPermissionMode: "Codex 权限模式",
      rowCodexPermissionModeDesc: "Native 保持 Codex AutoReview 和终端原生提示接管；Intercept 显示 DeskBuddy 允许/拒绝气泡。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      codexHookHealthReasonNeedsReview: "DeskBuddy 的 Codex hooks 已注册但需在 Codex 里确认——在 Codex 运行 /hooks，或用 Doctor → Fix。",
      codexHookHealthReasonInactive: "DeskBuddy 的 Codex hook 未生效，审批提示不会弹出。请重装集成或用 Doctor → Fix 修复。",
      ...
      rowSoundDesc: "DeskBuddy 完成任务或需要输入时播放提示音。",
      rowVolume: "音量",
      rowVolumeDesc: "调整音效音量。关闭音效时不可用。",
      rowLowPowerIdleMode: "低功耗 idle",
      rowLowPowerIdleModeDesc: "DeskBuddy 静止几秒后暂停 idle SVG 动画；有活动时会立即恢复动画。",
      ...
      rowSessionCleanupGroupDesc: "DeskBuddy 等待多久才清理不活跃会话。主要影响远程 SSH 会话（看不到终端窗口）——远程长任务可调大；设为 0 则永远不按时间清理。",
      ...
      rowOpenAtLogin: "开机自启",
      rowOpenAtLoginDesc: "登录系统时自动启动 DeskBuddy。",
      ...
      claudeHooksDisconnectConfirmDetail: "这会从 `~/.claude/settings.json` 移除 DeskBuddy 管理的 Claude hooks，并关闭自动管理。`随 Claude Code 启动` 的偏好会保留，方便以后重新启用。",
      claudeHooksDisconnectConfirmAction: "断开 hooks",
      claudeHooksDisconnectConfirmKeep: "继续保留",
      rowStartWithClaude: "随 Claude Code 启动",
      rowStartWithClaudeDesc: "Claude Code 会话开始时自动拉起 DeskBuddy。",
      rowStartWithClaudeDisabledDesc: "需要先开启 Claude hooks 自动管理。关闭期间，端口变化和外部覆盖都不会被自动修补。",
      rowHideBubbles: "隐藏气泡",
      rowHideBubblesDesc: "隐藏 DeskBuddy 的权限、通知和更新气泡。",
      rowBubbleFollow: "气泡跟随 DeskBuddy",
      ...
      autoApproveAllConfirmDetail: "所有 agent 的每一个权限请求都会被自动通过，包括执行 shell 命令和删除文件。DeskBuddy 不会再先问你。只有在你完全信任 agent 的行为时才开启。",
      ...
      updateBubbleDisableConfirmDetail: "隐藏后可能错过更新失败原因、下载完成提示和重启安装提示。更新流程本身仍会继续，但 DeskBuddy 不再显示更新气泡。",
      ...
      placeholderDesc: "此面板将在 DeskBuddy 后续版本中加入，规划见 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主题",
      themeSubtitle: "为 DeskBuddy 选择一个主题。卡片会显示内建和能力角标，切换前就能看出 tracked / static / mini 等差异。",
      themeEmpty: "没有可用的主题。",
      ...
      themeImportUserThemeZip: "导入 DeskBuddy 主题包（.zip）",
      themeImportUserThemeZipHint: "DeskBuddy 主题 zip：根目录或一个顶层文件夹内必须包含 theme.json；素材放在 assets/，可使用 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 包请用上方入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已刷新：新增 ${imported}，更新 ${updated}，未变 ${unchanged}，移除 ${removed}${invalid ? `，无效 ${invalid}` : ""}${switched ? "；当前主题已回退到 DeskBuddy" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已卸载 "${name}"${switched ? "，并切回 DeskBuddy" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `卸载导入宠物失败：${message}`,
      animMapTitle: "动画映射",
      animMapSubtitle: "关掉不想看的打扰动画。事件照样会触发——DeskBuddy 只是不再播放对应的动画和音效。",
      ...
      aboutTitle: "关于 DeskBuddy",
      aboutSubtitle: "陪你处理 AI 编码会话的桌面伙伴。",
      ...
      aboutSourceReposLabel: "源仓库",
      aboutLicenseLabel: "开源协议",
      aboutAuthorLabel: "作者",
      aboutMaintainersLabel: "维护者",
      aboutContributorsLabel: "贡献者",
      aboutFooter: "DeskBuddy 是开源项目 · 与社区一起打造。",
      aboutCleanupButton: "移除 DeskBuddy 集成…",
      aboutCleanupConfirm: "要移除本机各 agent 里的 DeskBuddy 管理 hooks / plugins，并在 DeskBuddy 里把所有 agent 集成标记为未安装且禁用吗？不会删除 agent 应用或用户配置。",
      aboutCleanupRunning: "正在移除集成…",
      aboutCleanupSuccess: "已从 {affected} 个集成移除 {removed} 项，失败 {failed} 项。",
      aboutCleanupFailed: "集成清理失败",
      aboutCleanupKiroNote: "Kiro 的 deskbuddy.json 已保留，只移除了 hook 条目。",
      mobileTitle: "DeskBuddy Mobile",
      mobileDeviceName: "设备名称",
      mobileDesc: "将这台设备添加到手机上的 DeskBuddy Mobile 应用，随时查看会话状态。只读局域网预览——无写入或审批操作。",
      ...
      mobileQrHint: "用手机相机扫描以打开 DeskBuddy Mobile",
      mobileQrHintNative: "用 DeskBuddy Mobile 应用内置的扫描功能扫描",
      mobileClientPwa: "PWA（浏览器）",
      mobileClientNative: "原生应用",
      mobileClientNativeNote: "需要已安装 DeskBuddy Mobile 应用——该链接不会回退到浏览器。",
      mobileRegenerate: "重新生成令牌",
      mobileRegenerateConfirm: "确定重新生成令牌？所有已连接设备将断开，需要重新配对。",
      mobileReset: "重置移动端访问",
      mobileResetConfirm: "确定重置移动端访问？所有设备将断开并生成新令牌。",
      mdownManagerTitle: "MDown Manager",
      mdownManagerSubtitle: "将 MDM 桌宠连接到正在运行的 MDown Manager 实例，让它反映真实的扫描/摘要/索引活动，而不是一直处于空闲状态。",
      mdownManagerStatusChecking: "检查中…",
      mdownManagerStatusNotConfigured: "尚未配置 — 请在下方粘贴 API key。",
      mdownManagerStatusConnected: "已连接。",
      mdownManagerStatusUnauthorized: "未授权 — 请检查 API key。",
      mdownManagerStatusOffline: "离线 — MDown Manager 是否正在运行？",
      mdownManagerConnectionSectionTitle: "连接",
      mdownManagerBaseUrlLabel: "本地 API 地址",
      mdownManagerBaseUrlEmpty: "请先填写 MDown Manager API 地址。",
      mdownManagerApiKeyLabel: "API key",
      mdownManagerApiKeyHint: "从 MDown Manager 的 设置 → Local Agent API 面板复制。",
      mdownManagerApiKeyPlaceholder: "粘贴 API key",
      mdownManagerApiKeyConfiguredPlaceholder: "已保存 — 留空以保留原值",
      mdownManagerSave: "保存",
      mdownManagerSaving: "保存中…",
      mdownManagerConfigSaved: "MDown Manager 设置已保存。",
      mdownManagerEnableSectionTitle: "启用",
      mdownManagerEnableLabel: "反映 MDown Manager 活动",
      mdownManagerEnableDesc: "启用后，MDM 桌宠会根据 MDown Manager 的实际状态在 空闲/扫描/摘要/索引/错误 之间切换。",
      aboutOpenExternalFailed: "无法在浏览器中打开链接。",
    },
    "zh-TW": {
      settingsTitle: "設定",
      settingsSubtitle: "設定 DeskBuddy 在桌面上怎麼動作。",
      ...
      statsTitle: "統計",
      statsSubtitle: "根據目前工作階段快照彙整的 DeskBuddy 活動即時概覽。",
      statsLoadingTitle: "正在載入統計",
      statsLoadingBody: "DeskBuddy 正在收集最新的工作階段快照。",
      statsLoadFailed: "無法載入統計",
      statsEmptyTitle: "尚無工作階段活動",
      statsEmptyBody: "啟動 Claude Code、Codex 或其他已連線的 agent，活動概覽就會顯示在這裡。",
      statsCardSessions: "已觀察到的工作階段",
      statsCardActive: "目前活躍",
      statsCardNeedsAck: "等待確認",
      statsCardCoverage: "覆蓋率",
      statsAgentsTitle: "Agent 活動",
      statsAgentsEmpty: "尚無 Agent 活動。",
      statsProjectsTitle: "專案活動",
      statsProjectsEmpty: "尚未回報任何專案路徑。",
      statsStatusTitle: "狀態分佈",
      statsStatusEmpty: "尚無工作階段狀態。",
      statsHealthTitle: "健康狀態",
      statsHealthLastActivity: "最近活動",
      statsHealthContext: "上下文壓力",
      statsHealthRemote: "遠端覆蓋率",
      statsLocalLabel: "本機",
      statsRemoteLabel: "遠端",
      statsDoneLabel: "已完成",
      statsInterruptedLabel: "已中斷",
      statsReposLabel: "儲存庫數",
      statsHostsLabel: "主機數",
      statsTrackedLabel: "已追蹤",
      statsNearLimitLabel: "接近上限",
      statsPeakLabel: "峰值",
      statsSessionsLabel: "工作階段數",
      statsActiveShort: "活躍",
      statsUnknownRepo: "未知儲存庫",
      statsUnknownLabel: "未知",
      statsNever: "尚無最近活動",
      pluginsTitle: "外掛",
      pluginsSubtitle: "受 OpenPets 外掛選單啟發的 DeskBuddy 內建動作。已啟用的外掛會直接出現在桌寵右鍵選單中。",
      pluginsLoadingTitle: "正在載入外掛",
      pluginsLoadingBody: "DeskBuddy 正在收集目前的外掛狀態。",
      pluginsLoadFailed: "無法載入外掛",
      pluginsEmptyTitle: "尚無可用外掛",
      pluginsEmptyBody: "DeskBuddy 載入完成後，內建外掛會顯示在這裡。",
      pluginsFilterAll: "全部",
      pluginsFilterEnabled: "已啟用",
      pluginsFilterDisabled: "已停用",
      pluginsFilterMenu: "選單",
      pluginsStatusActive: "已啟用",
      pluginsStatusDisabled: "已停用",
      pluginsStatusBundled: "內建",
      pluginsStatusMenu: "桌寵選單",
      pluginsCommandsLabel: "指令",
      pluginsActionConfigure: "設定",
      pluginsActionHide: "隱藏",
      pluginsFooterCount: "共 {count} 個內建外掛",
      pluginBreakBuddyName: "休息小幫手",
      pluginBreakBuddyDesc: "安排溫和的休息提醒，讓桌寵提醒你抽空離開一下。",
      pluginBreakBuddyMenuFive: "5 分鐘後提醒我",
      pluginBreakBuddyMenuTen: "10 分鐘後提醒我",
      pluginBreakBuddyMenuCancel: "取消休息提醒",
      pluginBreakBuddyQueuedTitle: "休息小幫手",
      pluginBreakBuddyQueuedFive: "已設定 5 分鐘後提醒休息。",
      pluginBreakBuddyQueuedTen: "已設定 10 分鐘後提醒休息。",
      pluginBreakBuddyReadyTitle: "該休息一下了",
      pluginBreakBuddyReadyBody: "起身走走，伸展一下，讓眼睛放鬆片刻。",
      pluginBreakBuddyCanceledBody: "休息提醒已取消。",
      pluginFocusBuddyName: "專注小幫手",
      pluginFocusBuddyDesc: "開啟簡單的專注計時，讓桌寵在工作階段該收尾時提醒你。",
      pluginFocusBuddyMenuTwentyFive: "開始 25 分鐘專注",
      pluginFocusBuddyMenuFifty: "開始 50 分鐘專注",
      pluginFocusBuddyMenuCancel: "取消專注計時",
      pluginFocusBuddyQueuedTitle: "專注小幫手",
      pluginFocusBuddyQueuedTwentyFive: "25 分鐘專注計時已開始。",
      pluginFocusBuddyQueuedFifty: "50 分鐘專注計時已開始。",
      pluginFocusBuddyReadyTitle: "專注時段完成",
      pluginFocusBuddyReadyBody: "專注時段已結束。回顧一下，提交程式碼，喘口氣。",
      pluginFocusBuddyCanceledBody: "專注計時已取消。",
      pluginPetPalName: "桌寵夥伴",
      pluginPetPalDesc: "快速開啟你在工作階段中最常查看的活動面板。",
      pluginPetPalMenuDashboard: "開啟工作階段面板",
      pluginPetPalMenuStats: "開啟統計",
      pluginPetPalMenuAgents: "開啟 Agent 設定",
      pluginQuickRemindersName: "快速提醒",
      pluginQuickRemindersDesc: "在不離開桌寵選單的情況下，安排一個輕量的後續提醒。",
      pluginQuickRemindersMenuTen: "10 分鐘後提醒我",
      pluginQuickRemindersMenuThirty: "30 分鐘後提醒我",
      pluginQuickRemindersMenuHour: "1 小時後提醒我",
      pluginQuickRemindersMenuCancel: "取消提醒",
      pluginQuickRemindersQueuedTitle: "快速提醒",
      pluginQuickRemindersQueuedTen: "已設定 10 分鐘後提醒。",
      pluginQuickRemindersQueuedThirty: "已設定 30 分鐘後提醒。",
      pluginQuickRemindersQueuedHour: "已設定 1 小時後提醒。",
      pluginQuickRemindersReadyTitle: "提醒",
      pluginQuickRemindersReadyBody: "DeskBuddy 提醒你：回顧一下之前擱置的任務。",
      pluginQuickRemindersCanceledBody: "提醒已取消。",
      pluginWanderBuddyName: "漫遊小幫手",
      pluginWanderBuddyDesc: "透過選單直接切換 DeskBuddy 的移動選項，讓桌寵更自由地漫遊。",
      pluginWanderBuddyMenuFreeRoam: "自由漫遊",
      pluginWanderBuddyMenuEdgePinning: "允許貼邊固定",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "到 [@BotFather](https://t.me/botfather) 用 /newbot 建立機器人，把 token 貼在這裡。Token 儲存在 userData env 檔，不會寫入 deskbuddy-prefs.json。",
      ...
      telegramApprovalRecipientHintHtml: "到 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私訊 /start 取得你的數字 ID。DeskBuddy 會用它同時做為唯一核准者與接收核准卡片的 chat。記得先到你自己的機器人發一次 /start 啟動私訊。",
      telegramApprovalRecipientPlaceholder: "例如：123456789",
      ...
      telegramApprovalDirectSendDesc: "回覆 DeskBuddy 完成通知時，聚焦對應的本機終端並貼上單行文字。不會按 Enter。",
      ...
      remoteSshSubtitle: "管理一鍵 SSH 通道，讓遠端 AI 程式設計工作階段像在本機一樣順手。DeskBuddy 不會留下任何密碼或私鑰通行片語——靠你已經設好的 ssh-agent 或 SSH 金鑰。",
      ...
      remoteSshFieldConnectOnLaunch: "DeskBuddy 啟動時自動連線",
      ...
      remoteSshErrNoLocalPort: "本機 DeskBuddy 服務尚未啟動。",
      remoteSshErrUnknownStrikes: "連續多次無法識別錯誤，請檢查設定和記錄檔。",
      remoteSshProbeLocalUnhealthy: "通道已建立，但本機 DeskBuddy 服務狀態異常。",
      remoteSshProbeUnresponsive: "通道已建立，但 DeskBuddy 沒有回應，請確認 DeskBuddy 是否正在執行。",
      ...
      remoteSshHooksDeployedAgoDay: "{n} 天前部署",
      remoteSshConnectWarnNoDeploy: "Hook 檔案還沒部署。Connect 只接 SSH 通道、不會部署 hook——要先點 Deploy / Repair Hooks，DeskBuddy 才會回應遠端工作階段。",
      ...
      doctorPrivacy: "隱私權聲明：診斷報告只在本機產生，DeskBuddy 不會上傳任何資料。複製前會自動把使用者路徑和金鑰遮起來。",
      ...
      doctorFixConfirmCodex: "DeskBuddy 會把 Codex 設定裡的 [features].hooks 改成 true。要繼續嗎？",
      doctorFixConfirmCodexTitle: "啟用 Codex hooks？",
      doctorFixConfirmCodexDetail: "這次修復會更動你的 Codex 設定，把 [features].hooks 改成 true。除非你在這裡確認，否則 DeskBuddy 不會更動。",
      doctorFixConfirmCodexAction: "啟用並修復",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重新啟動 DeskBuddy",
      doctorRestarting: "重新啟動中",
      doctorRestartConfirmTitle: "重新啟動 DeskBuddy？",
      doctorRestartConfirmDetail: "DeskBuddy 會關掉再開起來。AI coding agent 還在跑的請求會被中斷。重新啟動時 Doctor 視窗也會一起關掉。",
      ...
      doctorConnectionNoActivityHint: "測試期間沒有 agent 的 hook 流量到達 DeskBuddy。如果你還沒啟用 agent，請先在設定裡啟用或安裝一個，然後從該 agent 發一則訊息，再重新測試。",
      ...
      hardwareBuddyQuickCommandsDesc: "顯示本機 preset 按鈕，只建立由 adapter 處理的 quick_command 事件；DeskBuddy 不貼上文字，也不執行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "要解除安裝這個由 DeskBuddy 管理的整合嗎？只會移除 DeskBuddy 管理的 hooks、外掛或擴充功能。",
      agentIntegrationInstallSkipped: "沒有偵測到本機安裝了 {agents}，所以沒有寫入整合。",
      agentListSeparator: "、",
      agentInstallHintTitle: "連接偵測到的 Agent",
      agentInstallHintDesc: "偵測到本機可能有 {agents}。安裝由 DeskBuddy 管理的 hooks、外掛或擴充功能後，它們就能驅動桌寵。",
      agentInstallHintInstallRecommended: "安裝推薦項",
      agentInstallHintDismiss: "暫不處理",
      agentCleanupHintTitle: "檢查缺失的本機 Agent",
      agentCleanupHintDesc: "DeskBuddy 目前連接了 {agents}，但本機沒有偵測到對應安裝。移除 DeskBuddy 管理的整合後，也會關閉這些 agent 的啟動同步與事件入口。",
      agentCleanupHintRemove: "移除整合",
      agentCleanupHintDismiss: "先保留",
      rowAgentPermissions: "顯示彈出視窗",
      rowAgentPermissionsDesc: "關掉以後，這個 agent 會改由自己的終端機處理提示，不會再彈 DeskBuddy 對話框。",
      rowAgentSubagentPermissions: "子 agent 權限彈窗",
      rowAgentSubagentPermissionsDesc: "關掉以後，Task 子 agent 發起的權限請求不會再彈 DeskBuddy 對話框，改回終端機處理。",
      rowCodexPermissionMode: "Codex 權限模式",
      rowCodexPermissionModeDesc: "Native 維持 Codex AutoReview 和終端機原本的提示；Intercept 改成顯示 DeskBuddy 的允許或拒絕對話框。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      codexHookHealthReasonNeedsReview: "DeskBuddy 的 Codex hooks 已註冊但需在 Codex 裡確認——在 Codex 執行 /hooks，或用 Doctor → Fix。",
      codexHookHealthReasonInactive: "DeskBuddy 的 Codex hook 未生效，審批提示不會跳出。請重新安裝整合或用 Doctor → Fix 修復。",
      ...
      rowSoundDesc: "DeskBuddy 完成任務或要等輸入時會播放提示聲。",
      rowVolume: "音量",
      rowVolumeDesc: "調整音效音量。停用音效後無法使用。",
      rowLowPowerIdleMode: "低耗電閒置狀態",
      rowLowPowerIdleModeDesc: "DeskBuddy 不動幾秒後就暫停閒置狀態 SVG 動畫；有活動時立即恢復。",
      ...
      rowSessionCleanupGroupDesc: "DeskBuddy 等多久才清掉沒動靜的工作階段。主要影響遠端 SSH 工作階段（看不到終端機）——遠端長任務可以放寬；設成 0 就完全不按時間清。",
      ...
      rowOpenAtLoginDesc: "登入系統時自動啟動 DeskBuddy。",
      ...
      claudeHooksDisconnectConfirmDetail: "這會從 `~/.claude/settings.json` 移除 DeskBuddy 管的 Claude hooks，並關掉自動管理。「隨 Claude Code 啟動」的偏好會保留，方便之後再開啟。",
      claudeHooksDisconnectConfirmAction: "中斷 hooks 連線",
      claudeHooksDisconnectConfirmKeep: "繼續保留",
      rowStartWithClaude: "隨 Claude Code 啟動",
      rowStartWithClaudeDesc: "Claude Code 工作階段一開始就自動把 DeskBuddy 叫起來。",
      rowStartWithClaudeDisabledDesc: "要先開啟 Claude hooks 自動管理。關掉的時候，連接埠變動和外部更動都不會自動修。",
      rowHideBubbles: "隱藏對話框",
      rowHideBubblesDesc: "隱藏 DeskBuddy 的權限、通知和更新對話框。",
      rowBubbleFollow: "對話框跟著 DeskBuddy",
      ...
      autoApproveAllConfirmDetail: "所有 agent 的每一個權限請求都會被自動允許，包括執行 shell 命令和刪除檔案。DeskBuddy 不會再先問你。只有在你完全信任 agent 的行為時才開啟。",
      ...
      updateBubbleDisableConfirmDetail: "隱藏後可能會錯過更新失敗原因、下載完成提示和重新啟動安裝提示。更新流程本身還是會繼續，只是 DeskBuddy 不再顯示更新對話框。",
      ...
      placeholderDesc: "這個面板會在 DeskBuddy 後續版本加入，規劃見 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主題",
      themeSubtitle: "幫 DeskBuddy 選擇主題。主題卡會顯示是否為內建主題，以及游標跟隨、靜態、迷你模式等支援項目，方便切換前比較差異。",
      themeEmpty: "沒有主題可以用。",
      ...
      themeImportUserThemeZip: "匯入 DeskBuddy 主題套件（.zip）",
      themeImportUserThemeZipHint: "DeskBuddy 主題 zip：根目錄或單一頂層資料夾裡要有 theme.json；素材放在 assets/，支援 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 套件請改用上面的入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已重新整理：新增 ${imported}，更新 ${updated}，沒變 ${unchanged}，移除 ${removed}${invalid ? `，無效 ${invalid}` : ""}${switched ? "；目前主題已切回 DeskBuddy" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已解除安裝「${name}」${switched ? "，並切回 DeskBuddy" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `解除安裝匯入的寵物失敗：${message}`,
      animMapTitle: "動畫對應",
      animMapSubtitle: "關掉不想看的打擾動畫。事件還是會觸發——DeskBuddy 只是不再播對應的動畫和音效。",
      ...
      aboutTitle: "關於 DeskBuddy",
      aboutSubtitle: "陪你處理 AI 編碼工作階段的桌面夥伴。",
      ...
      aboutSourceReposLabel: "來源倉庫",
      aboutLicenseLabel: "開源授權",
      aboutAuthorLabel: "作者",
      aboutMaintainersLabel: "維護者",
      aboutContributorsLabel: "貢獻者",
      aboutFooter: "DeskBuddy 是開源專案 · 和社群一起做出來的。",
      aboutCleanupButton: "移除 DeskBuddy 整合…",
      aboutCleanupConfirm: "要移除本機各 agent 內由 DeskBuddy 管理的 hooks / plugins，並在 DeskBuddy 中將所有 agent 整合標記為未安裝且停用嗎？不會刪除 agent 應用程式或使用者設定。",
      aboutCleanupRunning: "正在移除整合…",
      aboutCleanupSuccess: "已從 {affected} 個整合移除 {removed} 項，失敗 {failed} 項。",
      aboutCleanupFailed: "整合清理失敗",
      aboutCleanupKiroNote: "Kiro 的 deskbuddy.json 已保留，只移除了 hook 條目。",
      mobileTitle: "DeskBuddy Mobile",
      mobileDeviceName: "裝置名稱",
      mobileDesc: "將這台裝置加入手機上的 DeskBuddy Mobile 應用程式，隨時查看工作階段狀態。唯讀區域網路預覽——無寫入或核准操作。",
      ...
      mobileQrHint: "用手機相機掃描以開啟 DeskBuddy Mobile",
      mobileQrHintNative: "用 DeskBuddy Mobile 應用程式內建的掃描功能掃描",
      mobileClientPwa: "PWA（瀏覽器）",
      mobileClientNative: "原生應用程式",
      mobileClientNativeNote: "需要已安裝 DeskBuddy Mobile 應用程式——此連結不會回退到瀏覽器。",
      mobileRegenerate: "重新生成令牌",
      mobileRegenerateConfirm: "確定重新生成令牌？所有已連線裝置將斷線，需要重新配對。",
      mobileReset: "重置行動裝置存取",
      mobileResetConfirm: "確定重置行動裝置存取？所有裝置將斷線並產生新令牌。",
      mdownManagerTitle: "MDown Manager",
      mdownManagerSubtitle: "將 MDM 桌寵連接到正在執行的 MDown Manager 執行個體，讓牠反映真實的掃描/摘要/索引活動，而不是一直閒置。",
      mdownManagerStatusChecking: "檢查中…",
      mdownManagerStatusNotConfigured: "尚未設定 — 請在下方貼上 API key。",
      mdownManagerStatusConnected: "已連線。",
      mdownManagerStatusUnauthorized: "未授權 — 請檢查 API key。",
      mdownManagerStatusOffline: "離線 — MDown Manager 是否正在執行？",
      mdownManagerConnectionSectionTitle: "連線",
      mdownManagerBaseUrlLabel: "本機 API 網址",
      mdownManagerBaseUrlEmpty: "請先輸入 MDown Manager API 網址。",
      mdownManagerApiKeyLabel: "API key",
      mdownManagerApiKeyHint: "從 MDown Manager 的 設定 → Local Agent API 面板複製。",
      mdownManagerApiKeyPlaceholder: "貼上 API key",
      mdownManagerApiKeyConfiguredPlaceholder: "已儲存 — 留空以保留原值",
      mdownManagerSave: "儲存",
      mdownManagerSaving: "儲存中…",
      mdownManagerConfigSaved: "MDown Manager 設定已儲存。",
      mdownManagerEnableSectionTitle: "啟用",
      mdownManagerEnableLabel: "反映 MDown Manager 活動",
      mdownManagerEnableDesc: "啟用後，MDM 桌寵會依據 MDown Manager 的實際狀態，在 閒置/掃描/摘要/索引/錯誤 之間切換。",
      aboutOpenExternalFailed: "無法開啟瀏覽器連結。",
    },
    ko: {
      settingsTitle: "설정",
      settingsSubtitle: "데스크톱에서 DeskBuddy의 동작 방식을 설정합니다.",
      ...
      statsTitle: "통계",
      statsSubtitle: "현재 세션 스냅샷을 기준으로 정리한 DeskBuddy 활동 실시간 개요입니다.",
      statsLoadingTitle: "통계 불러오는 중",
      statsLoadingBody: "DeskBuddy가 최신 세션 스냅샷을 수집하고 있습니다.",
      statsLoadFailed: "통계를 불러올 수 없습니다",
      statsEmptyTitle: "아직 세션 활동이 없습니다",
      statsEmptyBody: "Claude Code, Codex 또는 다른 연결된 에이전트를 시작하면 활동 개요가 여기에 표시됩니다.",
      statsCardSessions: "관찰된 세션",
      statsCardActive: "현재 활성",
      statsCardNeedsAck: "확인 대기 중",
      statsCardCoverage: "커버리지",
      statsAgentsTitle: "에이전트 활동",
      statsAgentsEmpty: "아직 에이전트 활동이 없습니다.",
      statsProjectsTitle: "프로젝트 활동",
      statsProjectsEmpty: "아직 보고된 프로젝트 경로가 없습니다.",
      statsStatusTitle: "상태 분포",
      statsStatusEmpty: "아직 세션 상태가 없습니다.",
      statsHealthTitle: "상태 점검",
      statsHealthLastActivity: "최근 활동",
      statsHealthContext: "컨텍스트 압박도",
      statsHealthRemote: "원격 커버리지",
      statsLocalLabel: "로컬",
      statsRemoteLabel: "원격",
      statsDoneLabel: "완료",
      statsInterruptedLabel: "중단됨",
      statsReposLabel: "저장소",
      statsHostsLabel: "호스트",
      statsTrackedLabel: "추적 중",
      statsNearLimitLabel: "한도 임박",
      statsPeakLabel: "최고치",
      statsSessionsLabel: "세션",
      statsActiveShort: "활성",
      statsUnknownRepo: "알 수 없는 저장소",
      statsUnknownLabel: "알 수 없음",
      statsNever: "최근 활동 없음",
      pluginsTitle: "플러그인",
      pluginsSubtitle: "OpenPets 플러그인 메뉴에서 영감을 받은 DeskBuddy 내장 동작입니다. 활성화된 플러그인은 펫 우클릭 메뉴에 바로 표시됩니다.",
      pluginsLoadingTitle: "플러그인 불러오는 중",
      pluginsLoadingBody: "DeskBuddy가 현재 플러그인 상태를 수집하고 있습니다.",
      pluginsLoadFailed: "플러그인을 불러올 수 없습니다",
      pluginsEmptyTitle: "사용 가능한 플러그인이 없습니다",
      pluginsEmptyBody: "DeskBuddy 로딩이 끝나면 내장 플러그인이 여기에 표시됩니다.",
      pluginsFilterAll: "전체",
      pluginsFilterEnabled: "활성화됨",
      pluginsFilterDisabled: "비활성화됨",
      pluginsFilterMenu: "메뉴",
      pluginsStatusActive: "활성",
      pluginsStatusDisabled: "비활성",
      pluginsStatusBundled: "내장",
      pluginsStatusMenu: "펫 메뉴",
      pluginsCommandsLabel: "명령",
      pluginsActionConfigure: "설정",
      pluginsActionHide: "숨기기",
      pluginsFooterCount: "내장 플러그인 {count}개",
      pluginBreakBuddyName: "브레이크 버디",
      pluginBreakBuddyDesc: "부드러운 휴식 알림을 예약해 펫이 잠시 자리를 비우라고 알려줍니다.",
      pluginBreakBuddyMenuFive: "5분 후 알려주기",
      pluginBreakBuddyMenuTen: "10분 후 알려주기",
      pluginBreakBuddyMenuCancel: "휴식 알림 취소",
      pluginBreakBuddyQueuedTitle: "브레이크 버디",
      pluginBreakBuddyQueuedFive: "5분 후 휴식 알림이 설정되었습니다.",
      pluginBreakBuddyQueuedTen: "10분 후 휴식 알림이 설정되었습니다.",
      pluginBreakBuddyReadyTitle: "휴식할 시간이에요",
      pluginBreakBuddyReadyBody: "일어나서 스트레칭하고 잠시 눈을 쉬어 주세요.",
      pluginBreakBuddyCanceledBody: "휴식 알림이 취소되었습니다.",
      pluginFocusBuddyName: "포커스 버디",
      pluginFocusBuddyDesc: "간단한 집중 타이머를 시작해 세션을 마무리할 때 펫이 알려줍니다.",
      pluginFocusBuddyMenuTwentyFive: "25분 집중 시작",
      pluginFocusBuddyMenuFifty: "50분 집중 시작",
      pluginFocusBuddyMenuCancel: "집중 타이머 취소",
      pluginFocusBuddyQueuedTitle: "포커스 버디",
      pluginFocusBuddyQueuedTwentyFive: "25분 집중 타이머가 시작되었습니다.",
      pluginFocusBuddyQueuedFifty: "50분 집중 타이머가 시작되었습니다.",
      pluginFocusBuddyReadyTitle: "집중 세션 완료",
      pluginFocusBuddyReadyBody: "집중 시간이 끝났어요. 검토하고, 커밋하고, 잠시 숨을 돌리세요.",
      pluginFocusBuddyCanceledBody: "집중 타이머가 취소되었습니다.",
      pluginPetPalName: "펫 팔",
      pluginPetPalDesc: "세션 중 가장 자주 확인하는 활동 화면을 빠르게 여는 DeskBuddy 단축키입니다.",
      pluginPetPalMenuDashboard: "세션 대시보드 열기",
      pluginPetPalMenuStats: "통계 열기",
      pluginPetPalMenuAgents: "에이전트 설정 열기",
      pluginQuickRemindersName: "빠른 알림",
      pluginQuickRemindersDesc: "펫 메뉴를 벗어나지 않고도 가벼운 후속 알림을 예약합니다.",
      pluginQuickRemindersMenuTen: "10분 후 알려주기",
      pluginQuickRemindersMenuThirty: "30분 후 알려주기",
      pluginQuickRemindersMenuHour: "1시간 후 알려주기",
      pluginQuickRemindersMenuCancel: "알림 취소",
      pluginQuickRemindersQueuedTitle: "빠른 알림",
      pluginQuickRemindersQueuedTen: "10분 후 알림이 설정되었습니다.",
      pluginQuickRemindersQueuedThirty: "30분 후 알림이 설정되었습니다.",
      pluginQuickRemindersQueuedHour: "1시간 후 알림이 설정되었습니다.",
      pluginQuickRemindersReadyTitle: "알림",
      pluginQuickRemindersReadyBody: "DeskBuddy 알림: 아까 미뤄둔 작업을 다시 확인해 보세요.",
      pluginQuickRemindersCanceledBody: "알림이 취소되었습니다.",
      pluginWanderBuddyName: "원더 버디",
      pluginWanderBuddyDesc: "메뉴에서 DeskBuddy 이동 옵션을 바로 전환해 펫이 더 자유롭게 돌아다니게 합니다.",
      pluginWanderBuddyMenuFreeRoam: "자유 이동",
      pluginWanderBuddyMenuEdgePinning: "가장자리 고정 허용",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "[@BotFather](https://t.me/botfather)에서 /newbot으로 bot을 만들고 token을 여기에 붙여넣으세요. userData env 파일에 저장되며 deskbuddy-prefs.json에는 저장되지 않습니다.",
      ...
      telegramApprovalRecipientHintHtml: "Telegram에서 [@userinfobot](https://t.me/userinfobot)에게 /start를 보내 숫자 ID를 받으세요. DeskBuddy는 이 ID를 승인 가능한 유일한 사용자이자 승인 카드 수신 chat으로 사용합니다. 본인의 bot에게도 먼저 /start를 한 번 보내 비공개 채팅을 활성화해야 합니다.",
      ...
      telegramApprovalDirectSend: "Direct Send (paste-only)",
      telegramApprovalDirectSendDesc: "DeskBuddy 완료 알림에 답장하면 해당 로컬 터미널을 포커스하고 한 줄 텍스트를 붙여넣습니다. Enter는 누르지 않습니다.",
      ...
      remoteSshSubtitle: "원클릭 SSH 터널을 관리해 원격 AI 코딩 세션을 매끄럽게 사용하세요. DeskBuddy는 비밀번호나 패스프레이즈를 저장하지 않으며, 기존 ssh-agent / SSH 키를 사용합니다.",
      ...
      remoteSshFieldConnectOnLaunch: "DeskBuddy 시작 시 자동 연결",
      ...
      remoteSshErrNoLocalPort: "로컬 DeskBuddy 서버가 아직 시작되지 않았습니다.",
      remoteSshErrUnknownStrikes: "인식할 수 없는 오류가 연속 발생했습니다. 프로필과 로그를 확인하세요.",
      remoteSshProbeLocalUnhealthy: "터널은 연결되었지만 로컬 DeskBuddy 서버가 비정상입니다.",
      remoteSshProbeUnresponsive: "터널은 연결되었지만 DeskBuddy가 응답하지 않습니다. DeskBuddy가 실행 중인지 확인하세요.",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 파일이 아직 배포되지 않았습니다. Connect는 SSH 터널만 구축하므로, Deploy / Repair Hooks를 눌러야 원격 세션에 DeskBuddy가 반응합니다.",
      ...
      doctorPrivacy: "개인정보 안내: 진단 보고서는 로컬에서 생성됩니다. DeskBuddy는 데이터를 업로드하지 않으며 복사 전에 사용자 경로와 비밀값을 가립니다.",
      ...
      doctorFixConfirmCodex: "DeskBuddy가 Codex 설정의 [features].hooks를 true로 변경합니다. 계속할까요?",
      doctorFixConfirmCodexTitle: "Codex hooks를 켤까요?",
      doctorFixConfirmCodexDetail: "이 복구는 Codex 설정의 [features].hooks를 true로 변경합니다. 여기에서 확인하기 전에는 DeskBuddy가 이 변경을 하지 않습니다.",
      doctorFixConfirmCodexAction: "켜고 복구",
      doctorFixConfirmCancel: "취소",
      doctorRestartButton: "DeskBuddy 재시작",
      doctorRestarting: "재시작 중",
      doctorRestartConfirmTitle: "DeskBuddy를 재시작할까요?",
      doctorRestartConfirmDetail: "DeskBuddy가 종료된 뒤 다시 실행됩니다. 진행 중인 AI 코딩 에이전트 요청은 중단됩니다. 재시작 중에는 Doctor 창도 함께 닫힙니다.",
      ...
      doctorConnectionNoActivityHint: "테스트 중에 에이전트의 hook 트래픽이 DeskBuddy에 도달하지 않았습니다. 아직 에이전트를 활성화하지 않았다면 설정에서 활성화하거나 설치한 뒤, 해당 에이전트에서 메시지를 보내고 다시 테스트하세요.",
      ...
      hardwareBuddyQuickCommandsDesc: "로컬 preset 버튼을 표시해 adapter가 처리하는 quick_command 이벤트만 만듭니다. DeskBuddy는 텍스트를 붙여넣거나 shell을 실행하지 않습니다.",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "이 DeskBuddy 관리 통합을 제거할까요? DeskBuddy가 관리하는 hooks, 플러그인 또는 확장만 제거됩니다.",
      agentIntegrationInstallSkipped: "{agents}의 로컬 설치를 찾지 못해 통합을 쓰지 않았습니다.",
      agentListSeparator: ", ",
      agentInstallHintTitle: "감지된 에이전트 연결",
      agentInstallHintDesc: "{agents}에 대한 로컬 신호를 감지했습니다. DeskBuddy 관리 hooks, 플러그인 또는 확장을 설치해 DeskBuddy에 연결할 수 있습니다.",
      agentInstallHintInstallRecommended: "추천 항목 설치",
      agentInstallHintDismiss: "나중에",
      agentCleanupHintTitle: "누락된 로컬 에이전트 검토",
      agentCleanupHintDesc: "DeskBuddy가 {agents}에 연결되어 있지만 일치하는 로컬 설치를 찾지 못했습니다. DeskBuddy 관리 통합을 제거하면 해당 에이전트의 시작 동기화와 이벤트 입력도 꺼집니다.",
      agentCleanupHintRemove: "통합 제거",
      agentCleanupHintDismiss: "지금은 유지",
      rowAgentPermissions: "팝업 말풍선 표시",
      rowAgentPermissionsDesc: "끄면 이 에이전트는 DeskBuddy 말풍선 대신 자체 터미널에서 프롬프트를 처리합니다.",
      rowAgentSubagentPermissions: "서브 에이전트 권한 말풍선",
      rowAgentSubagentPermissionsDesc: "끄면 Task 서브 에이전트의 권한 요청은 DeskBuddy 말풍선 없이 터미널에서 처리됩니다.",
      rowCodexPermissionMode: "Codex 권한 모드",
      rowCodexPermissionModeDesc: "Native는 Codex AutoReview와 터미널 프롬프트를 그대로 사용합니다. Intercept는 DeskBuddy 허용/거부 말풍선을 표시합니다.",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      codexHookHealthReasonNeedsReview: "DeskBuddy의 Codex 훅이 등록됐지만 Codex에서 승인이 필요합니다 — Codex에서 /hooks를 실행하거나 Doctor → Fix를 사용하세요.",
      codexHookHealthReasonInactive: "DeskBuddy의 Codex 훅이 활성화되지 않아 승인 프롬프트가 표시되지 않습니다. 통합을 다시 설치하거나 Doctor → Fix를 실행하세요.",
      ...
      rowSoundDesc: "DeskBuddy가 작업을 마치거나 입력을 요청할 때 알림음을 재생합니다.",
      rowVolume: "볼륨",
      rowVolumeDesc: "효과음 볼륨을 조절합니다. 효과음이 꺼져 있을 때는 비활성화됩니다.",
      rowLowPowerIdleMode: "저전력 idle",
      rowLowPowerIdleModeDesc: "DeskBuddy가 몇 초 동안 가만히 있으면 idle SVG 애니메이션을 일시 중지하고, 활동이 있으면 즉시 다시 재생합니다.",
      ...
      rowSessionCleanupGroupDesc: "DeskBuddy가 비활성 세션을 얼마나 기다린 뒤 정리할지 설정합니다. 주로 터미널이 보이지 않는 원격 SSH 세션에 적용됩니다 — 장시간 원격 작업은 한도를 늘리거나, 세션 타임아웃을 0으로 두면 시간으로는 정리하지 않습니다.",
      ...
      rowOpenAtLoginDesc: "로그인할 때 DeskBuddy를 자동으로 시작합니다.",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json`에서 DeskBuddy가 관리하는 Claude hooks를 제거하고 자동 관리를 끕니다. `Claude Code와 함께 시작` 설정은 나중에 다시 켤 수 있도록 유지됩니다.",
      ...
      rowStartWithClaudeDesc: "Claude Code 세션이 시작될 때마다 DeskBuddy를 자동으로 실행합니다.",
      ...
      rowHideBubblesDesc: "DeskBuddy의 권한, 알림, 업데이트 말풍선을 숨깁니다.",
      rowBubbleFollow: "말풍선이 DeskBuddy를 따라다님",
      ...
      autoApproveAllConfirmDetail: "셸 명령 실행과 파일 삭제를 포함해 모든 에이전트의 모든 권한 요청이 자동으로 승인됩니다. DeskBuddy가 먼저 묻지 않습니다. 에이전트의 동작을 완전히 신뢰할 때만 켜세요.",
      ...
      updateBubbleDisableConfirmDetail: "업데이트 실패 원인, 다운로드 완료 메시지, 재시작 안내를 놓칠 수 있습니다. 업데이트 흐름은 계속 실행되지만 DeskBuddy는 업데이트 말풍선을 표시하지 않습니다.",
      ...
      rowFreeRoam: "자유 배회",
      rowFreeRoamDesc: "대기 중에 DeskBuddy가 책상 위를 자유롭게 돌아다닙니다. 마우스를 움직이면 멈춥니다.",
      ...
      placeholderDesc: "이 패널은 향후 DeskBuddy 릴리스에 추가됩니다. 계획은 docs/plans/plan-settings-panel.md에 있습니다.",
      ...
      langJapanese: "日本語",
      themeTitle: "테마",
      themeSubtitle: "DeskBuddy의 테마를 선택합니다. 카드에는 기본 제공/능력 배지가 표시되어 tracked/static/mini 차이를 미리 볼 수 있습니다.",
      ...
      themeImportUserThemeZip: "DeskBuddy 테마 패키지 가져오기 (.zip)",
      themeImportUserThemeZipHint: "DeskBuddy 테마 zip: 루트 또는 하나의 최상위 폴더에 theme.json이 있어야 합니다. SVG, GIF, APNG, PNG, WebP, JPG, JPEG 파일은 assets/에 넣으세요. Codex Pet 패키지는 위의 가져오기를 사용하세요.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet을 새로고침했습니다: 신규 ${imported}, 업데이트 ${updated}, 변경 없음 ${unchanged}, 제거 ${removed}${invalid ? `, 무효 ${invalid}` : ""}${switched ? "; 활성 테마를 DeskBuddy로 되돌림" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}"을(를) 제거했습니다${switched ? " (DeskBuddy로 전환됨)" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `가져온 펫을 제거하지 못했습니다: ${message}`,
      animMapTitle: "애니메이션 맵",
      animMapSubtitle: "개별 인터럽트 애니메이션을 끕니다. 이벤트는 계속 발생하지만 DeskBuddy는 선택한 상태의 화면과 소리만 건너뜁니다.",
      ...
      aboutTitle: "DeskBuddy 정보",
      aboutSubtitle: "AI 코딩 세션을 함께하는 데스크톱 버디.",
      ...
      aboutSourceReposLabel: "원본 저장소",
      aboutLicenseLabel: "라이선스",
      aboutAuthorLabel: "제작",
      aboutMaintainersLabel: "메인테이너",
      aboutContributorsLabel: "기여자",
      aboutFooter: "DeskBuddy는 오픈 소스이며 커뮤니티와 함께 만듭니다.",
      aboutCleanupButton: "DeskBuddy 통합 제거…",
      aboutCleanupConfirm: "로컬 에이전트의 DeskBuddy 관리 hooks/plugins를 제거하고 DeskBuddy의 모든 에이전트 통합을 미설치 및 비활성 상태로 표시할까요? 에이전트 앱이나 사용자 설정은 삭제하지 않습니다.",
      ...
      aboutCleanupKiroNote: "Kiro deskbuddy.json은 유지하고 hook 항목만 제거했습니다.",
      mobileTitle: "DeskBuddy Mobile",
      mobileDeviceName: "기기 이름",
      mobileDesc: "이 기기를 휴대폰의 DeskBuddy Mobile 앱에 추가하여 어디서나 세션을 모니터링하세요. 읽기 전용 LAN 미리보기이며 쓰기 또는 승인 작업은 없습니다.",
      ...
      mobileQrHint: "휴대폰 카메라로 스캔하여 DeskBuddy Mobile 열기",
      mobileQrHintNative: "DeskBuddy Mobile 앱의 내장 스캐너로 스캔하세요",
      mobileClientPwa: "PWA (브라우저)",
      mobileClientNative: "네이티브 앱",
      mobileClientNativeNote: "DeskBuddy Mobile 앱이 이미 설치되어 있어야 합니다 — 이 링크는 브라우저로 대체되지 않습니다.",
      ...
      mdownManagerTitle: "MDown Manager",
      mdownManagerSubtitle: "MDM 펫을 실행 중인 MDown Manager 인스턴스에 연결하면 항상 유휴 상태로 있는 대신 실제 스캔/요약/색인 활동을 반영합니다.",
      mdownManagerStatusChecking: "확인 중…",
      mdownManagerStatusNotConfigured: "설정되지 않음 — 아래에 API 키를 붙여넣으세요.",
      mdownManagerStatusConnected: "연결됨.",
      mdownManagerStatusUnauthorized: "인증 실패 — API 키를 확인하세요.",
      mdownManagerStatusOffline: "오프라인 — MDown Manager가 실행 중인가요?",
      mdownManagerConnectionSectionTitle: "연결",
      mdownManagerBaseUrlLabel: "로컬 API URL",
      mdownManagerBaseUrlEmpty: "먼저 MDown Manager API URL을 입력하세요.",
      mdownManagerApiKeyLabel: "API 키",
      mdownManagerApiKeyHint: "MDown Manager의 설정 → Local Agent API 패널에서 복사하세요.",
      mdownManagerApiKeyPlaceholder: "API 키 붙여넣기",
      mdownManagerApiKeyConfiguredPlaceholder: "저장됨 — 비워두면 기존 값 유지",
      mdownManagerSave: "저장",
      mdownManagerSaving: "저장 중…",
      mdownManagerConfigSaved: "MDown Manager 설정이 저장되었습니다.",
      mdownManagerEnableSectionTitle: "활성화",
      mdownManagerEnableLabel: "MDown Manager 활동 반영",
      mdownManagerEnableDesc: "활성화하면 MDM 펫이 MDown Manager의 실제 상태에 따라 유휴/스캔/요약/색인/오류 상태를 전환합니다.",
      aboutOpenExternalFailed: "링크를 브라우저에서 열 수 없습니다.",
    },
    ja: {
      settingsTitle: "設定",
      settingsSubtitle: "DeskBuddy のデスクトップでの動作を設定します。",
      ...
      statsTitle: "統計",
      statsSubtitle: "現在のセッションスナップショットから集計した DeskBuddy のアクティビティのライブ概要です。",
      statsLoadingTitle: "統計を読み込み中",
      statsLoadingBody: "DeskBuddy が最新のセッションスナップショットを収集しています。",
      statsLoadFailed: "統計を読み込めませんでした",
      statsEmptyTitle: "まだセッションのアクティビティがありません",
      statsEmptyBody: "Claude Code、Codex、または他の接続済みエージェントを起動すると、アクティビティ概要がここに表示されます。",
      statsCardSessions: "観測されたセッション",
      statsCardActive: "現在アクティブ",
      statsCardNeedsAck: "確認待ち",
      statsCardCoverage: "カバレッジ",
      statsAgentsTitle: "エージェントのアクティビティ",
      statsAgentsEmpty: "まだエージェントのアクティビティがありません。",
      statsProjectsTitle: "プロジェクトのアクティビティ",
      statsProjectsEmpty: "まだ報告されたプロジェクトパスがありません。",
      statsStatusTitle: "状態の内訳",
      statsStatusEmpty: "まだセッション状態がありません。",
      statsHealthTitle: "ヘルス",
      statsHealthLastActivity: "最終アクティビティ",
      statsHealthContext: "コンテキスト逼迫度",
      statsHealthRemote: "リモートカバレッジ",
      statsLocalLabel: "ローカル",
      statsRemoteLabel: "リモート",
      statsDoneLabel: "完了",
      statsInterruptedLabel: "中断",
      statsReposLabel: "リポジトリ",
      statsHostsLabel: "ホスト",
      statsTrackedLabel: "追跡中",
      statsNearLimitLabel: "上限に接近",
      statsPeakLabel: "ピーク",
      statsSessionsLabel: "セッション",
      statsActiveShort: "アクティブ",
      statsUnknownRepo: "不明なリポジトリ",
      statsUnknownLabel: "不明",
      statsNever: "最近のアクティビティなし",
      pluginsTitle: "プラグイン",
      pluginsSubtitle: "OpenPets のプラグインメニューから着想を得た DeskBuddy の内蔵アクションです。有効なプラグインはペットの右クリックメニューに直接表示されます。",
      pluginsLoadingTitle: "プラグインを読み込み中",
      pluginsLoadingBody: "DeskBuddy が現在のプラグイン状態を収集しています。",
      pluginsLoadFailed: "プラグインを読み込めませんでした",
      pluginsEmptyTitle: "利用可能なプラグインがありません",
      pluginsEmptyBody: "DeskBuddy の読み込みが完了すると、内蔵プラグインがここに表示されます。",
      pluginsFilterAll: "すべて",
      pluginsFilterEnabled: "有効",
      pluginsFilterDisabled: "無効",
      pluginsFilterMenu: "メニュー",
      pluginsStatusActive: "有効",
      pluginsStatusDisabled: "無効",
      pluginsStatusBundled: "内蔵",
      pluginsStatusMenu: "ペットメニュー",
      pluginsCommandsLabel: "コマンド",
      pluginsActionConfigure: "設定",
      pluginsActionHide: "非表示",
      pluginsFooterCount: "内蔵プラグイン {count} 件",
      pluginBreakBuddyName: "ブレイクバディ",
      pluginBreakBuddyDesc: "穏やかな休憩リマインダーを設定し、ペットが少し離れるタイミングを知らせます。",
      pluginBreakBuddyMenuFive: "5分後に知らせる",
      pluginBreakBuddyMenuTen: "10分後に知らせる",
      pluginBreakBuddyMenuCancel: "休憩リマインダーをキャンセル",
      pluginBreakBuddyQueuedTitle: "ブレイクバディ",
      pluginBreakBuddyQueuedFive: "5分後に休憩リマインダーを設定しました。",
      pluginBreakBuddyQueuedTen: "10分後に休憩リマインダーを設定しました。",
      pluginBreakBuddyReadyTitle: "休憩の時間です",
      pluginBreakBuddyReadyBody: "立ち上がってストレッチし、少し目を休めましょう。",
      pluginBreakBuddyCanceledBody: "休憩リマインダーをキャンセルしました。",
      pluginFocusBuddyName: "フォーカスバディ",
      pluginFocusBuddyDesc: "簡単な集中タイマーを開始し、セッションを切り上げる時間になったらペットが知らせます。",
      pluginFocusBuddyMenuTwentyFive: "25分の集中タイマーを開始",
      pluginFocusBuddyMenuFifty: "50分の集中タイマーを開始",
      pluginFocusBuddyMenuCancel: "集中タイマーをキャンセル",
      pluginFocusBuddyQueuedTitle: "フォーカスバディ",
      pluginFocusBuddyQueuedTwentyFive: "25分の集中タイマーを開始しました。",
      pluginFocusBuddyQueuedFifty: "50分の集中タイマーを開始しました。",
      pluginFocusBuddyReadyTitle: "集中セッション完了",
      pluginFocusBuddyReadyBody: "集中タイムが終わりました。振り返って、コミットして、一息つきましょう。",
      pluginFocusBuddyCanceledBody: "集中タイマーをキャンセルしました。",
      pluginPetPalName: "ペットパル",
      pluginPetPalDesc: "セッション中によく確認するアクティビティ画面をすばやく開く DeskBuddy のショートカットです。",
      pluginPetPalMenuDashboard: "セッションダッシュボードを開く",
      pluginPetPalMenuStats: "統計を開く",
      pluginPetPalMenuAgents: "エージェント設定を開く",
      pluginQuickRemindersName: "クイックリマインダー",
      pluginQuickRemindersDesc: "ペットメニューを離れずに、軽いフォローアップリマインダーを設定します。",
      pluginQuickRemindersMenuTen: "10分後に知らせる",
      pluginQuickRemindersMenuThirty: "30分後に知らせる",
      pluginQuickRemindersMenuHour: "1時間後に知らせる",
      pluginQuickRemindersMenuCancel: "リマインダーをキャンセル",
      pluginQuickRemindersQueuedTitle: "クイックリマインダー",
      pluginQuickRemindersQueuedTen: "10分後のリマインダーを設定しました。",
      pluginQuickRemindersQueuedThirty: "30分後のリマインダーを設定しました。",
      pluginQuickRemindersQueuedHour: "1時間後のリマインダーを設定しました。",
      pluginQuickRemindersReadyTitle: "リマインダー",
      pluginQuickRemindersReadyBody: "DeskBuddyからの確認: さっき後回しにしたタスクを見直しましょう。",
      pluginQuickRemindersCanceledBody: "リマインダーをキャンセルしました。",
      pluginWanderBuddyName: "ワンダーバディ",
      pluginWanderBuddyDesc: "メニューから DeskBuddy の移動オプションを直接切り替えて、ペットをより自由に歩き回らせます。",
      pluginWanderBuddyMenuFreeRoam: "自由に歩き回る",
      pluginWanderBuddyMenuEdgePinning: "端への固定を許可",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "[@BotFather](https://t.me/botfather) で /newbot を使って bot を作り、token をここに貼り付けます。token は userData env ファイルに保存され、deskbuddy-prefs.json には保存されません。",
      ...
      telegramApprovalRecipientHintHtml: "Telegram で [@userinfobot](https://t.me/userinfobot) に /start を送って数値 ID を取得します。DeskBuddy はこの ID を唯一の承認者と承認カードを送る chat の両方として使います。事前に自分の bot にも /start を一度送ってプライベートチャットを有効にしてください。",
      ...
      telegramApprovalDirectSendDesc: "DeskBuddy の完了通知に返信すると、対応するローカル端末をフォーカスして 1 行のテキストを貼り付けます。Enter は送信しません。",
      ...
      remoteSshSubtitle: "ワンクリック SSH トンネルを管理し、リモートの AI コーディングセッションをローカルのように扱えます。DeskBuddy はパスワードやパスフレーズを保存せず、既存の ssh-agent / SSH キーを使います。",
      ...
      remoteSshFieldConnectOnLaunch: "DeskBuddy 起動時に自動接続",
      ...
      remoteSshErrNoLocalPort: "ローカル DeskBuddy サーバーがまだ起動していません。",
      remoteSshErrUnknownStrikes: "認識できないエラーが連続して発生しました。プロフィールとログを確認してください。",
      remoteSshProbeLocalUnhealthy: "トンネルは確立しましたがローカル DeskBuddy サーバーが異常です。",
      remoteSshProbeUnresponsive: "トンネルは確立しましたが DeskBuddy が応答しません。DeskBuddy が起動しているか確認してください。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook ファイルがまだデプロイされていません。Connect は SSH トンネルを張るだけなので、Deploy / Repair Hooks を押さないとリモートセッションに DeskBuddy が反応しません。",
      ...
      doctorPrivacy: "プライバシー: この診断レポートはローカルで生成されます。DeskBuddy はデータをアップロードしません。コピー前にユーザーパスと秘密情報はマスクされます。",
      ...
      doctorFixConfirmCodex: "DeskBuddy が Codex 設定の [features].hooks を true にします。続行しますか？",
      doctorFixConfirmCodexTitle: "Codex hooks を有効にしますか？",
      doctorFixConfirmCodexDetail: "この修復は Codex 設定を変更し、[features].hooks を true にします。ここで確認するまで、DeskBuddy はこの変更を行いません。",
      doctorFixConfirmCodexAction: "有効化して修復",
      doctorFixConfirmCancel: "キャンセル",
      doctorRestartButton: "DeskBuddy を再起動",
      doctorRestarting: "再起動中",
      doctorRestartConfirmTitle: "DeskBuddy を再起動しますか？",
      doctorRestartConfirmDetail: "DeskBuddy を終了して再起動します。進行中の AI coding agent リクエストは切断されます。再起動中は Doctor ウィンドウも閉じます。",
      ...
      doctorConnectionNoActivityHint: "テスト中にエージェントの hook トラフィックが DeskBuddy に届きませんでした。まだエージェントを有効化していない場合は、設定で有効化またはインストールし、そのエージェントからメッセージを送ってから再度テストしてください。",
      ...
      hardwareBuddyQuickCommandsDesc: "ローカル preset ボタンを表示し、adapter が処理する quick_command イベントだけを作成します。DeskBuddy は貼り付けや shell 実行をしません。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "この DeskBuddy 管理の連携をアンインストールしますか？DeskBuddy が管理する hooks、プラグイン、または拡張機能だけを削除します。",
      agentIntegrationInstallSkipped: "{agents} のローカルインストールが見つからなかったため、連携は書き込まれませんでした。",
      agentListSeparator: "、",
      agentInstallHintTitle: "検出したエージェントを接続",
      agentInstallHintDesc: "{agents} のローカル信号を検出しました。DeskBuddy 管理の hooks、プラグイン、または拡張機能をインストールして DeskBuddy に接続できます。",
      agentInstallHintInstallRecommended: "おすすめをインストール",
      agentInstallHintDismiss: "後で",
      agentCleanupHintTitle: "見つからないローカルエージェントを確認",
      agentCleanupHintDesc: "DeskBuddy は {agents} に接続されていますが、一致するローカルインストールが検出されませんでした。DeskBuddy 管理の連携を削除すると、それらのエージェントの起動時同期とイベント入口もオフになります。",
      agentCleanupHintRemove: "連携を削除",
      agentCleanupHintDismiss: "今は保持",
      rowAgentPermissions: "ポップアップ吹き出しを表示",
      rowAgentPermissionsDesc: "オフにすると、このエージェントは DeskBuddy の吹き出しではなく自身のターミナル上でプロンプトを処理します。",
      rowAgentSubagentPermissions: "サブエージェントの権限吹き出し",
      rowAgentSubagentPermissionsDesc: "オフにすると、Task サブエージェントの権限リクエストは DeskBuddy の吹き出しを表示せず、ターミナル側で処理されます。",
      rowCodexPermissionMode: "Codex 権限モード",
      rowCodexPermissionModeDesc: "Native は Codex AutoReview とターミナルの標準プロンプトに任せます。Intercept は DeskBuddy の許可/拒否吹き出しを表示します。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      codexHookHealthReasonNeedsReview: "DeskBuddy の Codex フックは登録済みですが Codex での承認が必要です — Codex で /hooks を実行するか、Doctor → Fix を使用してください。",
      codexHookHealthReasonInactive: "DeskBuddy の Codex フックが有効でないため、承認プロンプトが表示されません。連携を再インストールするか Doctor → Fix を実行してください。",
      ...
      rowSoundDesc: "DeskBuddy がタスクを完了したとき、または入力を求めたときに音を再生します。",
      rowVolume: "音量",
      rowVolumeDesc: "効果音の音量を調整します。効果音オフの時は無効になります。",
      rowLowPowerIdleMode: "省電力アイドル",
      rowLowPowerIdleModeDesc: "数秒間 DeskBuddy が静止していたら idle SVG アニメーションを停止し、活動が再開すると即座に復帰します。",
      ...
      rowSessionCleanupGroupDesc: "DeskBuddy が非アクティブなセッションを整理するまでの待機時間。主にターミナルが見えないリモート SSH セッションに影響します — 長時間のリモート作業では制限を緩めるか、セッションタイムアウトを 0 にすると時間では整理しません。",
      ...
      rowOpenAtLoginDesc: "ログイン時に DeskBuddy を自動起動します。",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json` から DeskBuddy 管理の Claude hooks を削除し、自動管理をオフにします。`Claude Code と同時に起動` 設定は後で再有効化できるよう保持されます。",
      claudeHooksDisconnectConfirmAction: "hooks を切断",
      claudeHooksDisconnectConfirmKeep: "接続を維持",
      rowStartWithClaude: "Claude Code と同時に起動",
      rowStartWithClaudeDesc: "Claude Code セッションが開始するたびに DeskBuddy を自動起動します。",
      rowStartWithClaudeDisabledDesc: "Claude hooks の自動管理が必要です。管理がオフの間はポート変更や設定上書きが自動修復されません。",
      rowHideBubbles: "吹き出しを非表示",
      rowHideBubblesDesc: "DeskBuddy の権限・通知・アップデート吹き出しをまとめて非表示にします。",
      rowBubbleFollow: "吹き出しが DeskBuddy に追従",
      ...
      autoApproveAllConfirmDetail: "シェルコマンドの実行やファイルの削除を含め、すべてのエージェントのすべての権限リクエストが自動的に承認されます。DeskBuddy は事前に確認しません。エージェントの動作を完全に信頼できる場合のみ有効にしてください。",
      ...
      updateBubbleDisableConfirmDetail: "アップデートエラーの原因・ダウンロード完了通知・再起動プロンプトを見逃す可能性があります。アップデート処理自体は継続しますが、DeskBuddy は吹き出しを表示しません。",
      ...
      rowFreeRoam: "自由散策",
      rowFreeRoamDesc: "待機中にDeskBuddyがデスク上を自由に歩き回ります。マウスを動かすと停止します。",
      ...
      placeholderDesc: "このパネルは DeskBuddy の今後のリリースで追加されます。計画は docs/plans/plan-settings-panel.md にあります。",
      ...
      langJapanese: "日本語",
      themeTitle: "テーマ",
      themeSubtitle: "DeskBuddy のテーマを選びます。カードには組み込み・能力バッジが表示されるので、tracked / static / mini の違いを切替前に確認できます。",
      ...
      themeImportUserThemeZip: "DeskBuddy テーマパッケージをインポート（.zip）",
      themeImportUserThemeZipHint: "DeskBuddy テーマ zip: ルートまたは 1 つのトップフォルダに theme.json が必要です。SVG、GIF、APNG、PNG、WebP、JPG、JPEG は assets/ に入れてください。Codex Pet パッケージは上の入口を使います。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet を更新しました: 新規 ${imported}、更新 ${updated}、変更なし ${unchanged}、削除 ${removed}${invalid ? `、無効 ${invalid}` : ""}${switched ? "、使用中テーマを DeskBuddy に戻しました" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}" をアンインストールしました${switched ? "。DeskBuddy に戻しました" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `インポート済みペットをアンインストールできませんでした: ${message}`,
      animMapTitle: "アニメーションマップ",
      animMapSubtitle: "個別の割り込みアニメーションをオフにできます。イベント自体は発火しますが、DeskBuddy は選択した状態の表示と効果音をスキップします。",
      ...
      aboutTitle: "DeskBuddy について",
      aboutSubtitle: "AI コーディングセッションに寄り添うデスクトップ相棒。",
      ...
      aboutSourceReposLabel: "元のリポジトリ",
      aboutLicenseLabel: "ライセンス",
      aboutAuthorLabel: "制作",
      aboutMaintainersLabel: "メンテナー",
      aboutContributorsLabel: "コントリビューター",
      aboutFooter: "DeskBuddy はオープンソース。コミュニティと一緒に作っています。",
      aboutCleanupButton: "DeskBuddy 連携を削除…",
      aboutCleanupConfirm: "ローカル agent から DeskBuddy 管理の hooks/plugins を削除し、DeskBuddy のすべての agent 連携を未インストールかつ無効としてマークしますか？agent アプリやユーザー設定は削除しません。",
      ...
      aboutCleanupKiroNote: "Kiro の deskbuddy.json は保持し、hook 項目だけを削除しました。",
      mobileTitle: "DeskBuddy Mobile",
      mobileDeviceName: "デバイス名",
      mobileDesc: "このマシンをスマートフォンの DeskBuddy Mobile アプリに追加すると、どこからでもセッションを確認できます。読み取り専用 LAN プレビューで、書き込みや承認操作はできません。",
      ...
      mobileQrHint: "スマートフォンのカメラでスキャンして DeskBuddy Mobile を開く",
      mobileQrHintNative: "DeskBuddy Mobile アプリ内蔵のスキャナーでスキャン",
      mobileClientPwa: "PWA（ブラウザ）",
      mobileClientNative: "ネイティブアプリ",
      mobileClientNativeNote: "DeskBuddy Mobile アプリがインストール済みである必要があります — このリンクはブラウザにフォールバックしません。",
      ...
      mdownManagerTitle: "MDown Manager",
      mdownManagerSubtitle: "MDM ペットを実行中の MDown Manager インスタンスに接続すると、常に待機状態のままではなく、実際のスキャン・要約・インデックス作成の動きを反映するようになります。",
      mdownManagerStatusChecking: "確認中…",
      mdownManagerStatusNotConfigured: "未設定 — 下に API キーを貼り付けてください。",
      mdownManagerStatusConnected: "接続済み。",
      mdownManagerStatusUnauthorized: "認証エラー — API キーを確認してください。",
      mdownManagerStatusOffline: "オフライン — MDown Manager は起動していますか？",
      mdownManagerConnectionSectionTitle: "接続",
      mdownManagerBaseUrlLabel: "ローカル API URL",
      mdownManagerBaseUrlEmpty: "先に MDown Manager の API URL を入力してください。",
      mdownManagerApiKeyLabel: "API キー",
      mdownManagerApiKeyHint: "MDown Manager の 設定 → Local Agent API パネルからコピーしてください。",
      mdownManagerApiKeyPlaceholder: "API キーを貼り付け",
      mdownManagerApiKeyConfiguredPlaceholder: "保存済み — 空欄のままで既存の値を維持",
      mdownManagerSave: "保存",
      mdownManagerSaving: "保存中…",
      mdownManagerConfigSaved: "MDown Manager の設定を保存しました。",
      mdownManagerEnableSectionTitle: "有効化",
      mdownManagerEnableLabel: "MDown Manager の活動を反映",
      mdownManagerEnableDesc: "有効にすると、MDown Manager の実際の状態に応じて MDM ペットが 待機/スキャン/要約/インデックス作成/エラー を切り替えます。",
